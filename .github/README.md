...
For chat, prefer the official [Tau Zulip chat][zulip]. The [Discord server][discord]
and [`#support:dpc.pw` Matrix channel][matrix] are also available.
...
[zulip]: https://tauofunix.zulipchat.com/
