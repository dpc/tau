...
OAuth and testing decisions are recorded in [DESIGN-tau-ext-pim-google-oauth-flow](DESIGN-tau-ext-pim-google-oauth-flow.md) and [DESIGN-tau-ext-pim-testing-strategy](DESIGN-tau-ext-pim-testing-strategy.md).
