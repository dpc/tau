...
A bounded runtime index is installed only after exact canonical create-report
confirmation and binds native message tuple to original agent, report, verified
...
rejects. Actor display never affects authority. Every submitted reaction report
retains Tau reply authority even if presentation omits a marker. Delete revokes
source, reply, edit, and reaction authority immediately, while its report and
pre-ACK admission slot remain pending until exact canonical confirmation.
