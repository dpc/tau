...
Eligible targets are canonically confirmed create/edit reports and successful
sends, never reaction occurrences, help/control output, failed or unconfirmed
reports, or arbitrary Slack objects. A successful local ingress report
write/flush activates no target and is not a harness commit ACK. A successful send submits
