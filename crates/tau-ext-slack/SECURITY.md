...
message-report submission while the Slack installation and session remain
current. Failed submission installs nothing. Submission and flush do not
acknowledge downstream canonical commit: interception, append failure, or a crash
can leave Slack/local effects without a canonical fact. A bounded process-local native-id
