...
/// Exact harness-owned instruction used for an output-length continuation.
///
...
pub const OUTPUT_LENGTH_CONTINUATION_INSTRUCTION: &str = "The prior response reached the output-token limit before producing an answer or tool request. Stop extending the analysis and take the next concrete step.";
