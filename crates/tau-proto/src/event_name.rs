...
impl EventName {
    ...
    pub const EXTENSION_INTERNAL_PROMPT_SUBMIT_REQUEST: Self =
        Self::from_static(EventCategory::Extension, "internal_prompt_submit_request");
    ...
    pub const AGENT_MANUAL_COMPACTION_REQUESTED: Self =
    ...
    pub const AGENT_OUTER_TURN_STARTED: Self =
        Self::from_static(EventCategory::Agent, "outer_turn_started");
    pub const AGENT_OUTER_TURN_FINISHED: Self =
