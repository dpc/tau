...
## Activating-input wait lifecycle
...
FIFO-capacity decisions, and high-cardinality long-turn stress. Harness dispatch
tests own watcher fanout, durable facts and replay, initial snapshots, and
relation cleanup.
