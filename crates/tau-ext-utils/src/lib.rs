    ...
    fn register(self, builder: &mut ExtensionBuilder<Self::State>) {
        ...
        builder.tool_with_group_and_prompt_fragment(
            ...
            Some(tau_proto::PromptFragment::new(
                ...
                "Use the `timer` tool to schedule, cancel, or list session-scoped reminders. Timer wakeups arrive as internal prompts and should be cancelled when no longer needed.",
            )),
            handle_timer_tool,
        );
        builder
