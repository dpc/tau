...
publish `message.delivered`; successful sends publish `message.sent` before the
ordinary result.

Harness replay performs no Telegram I/O or publication and reconstructs no live
