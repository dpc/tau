...
/// Chat Completions replay must preserve the exact machine-readable wait
/// interruption framing in the provider's tool message.
#[test]
fn tool_result_text_preserves_typed_wait_interruption_fixture() {
