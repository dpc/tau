...
This extension bridges untrusted external XMPP text into Tau. Before changing routing, configuration, secrets, connection lifecycle, or tool behavior, read `specs/ARCH-tau-ext-xmpp.md`, the applicable local `specs/DESIGN-*.md` records, and `../../specs/ARCH-external-message-boundary.md`.
...
See the applicable `specs/DESIGN-*.md` records for MVP design decisions and documented limitations. See
